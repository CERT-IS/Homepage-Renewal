...
Rails.application.config.assets.precompile += %w( bootstrap/plugins/circles-master/circles.js )
Rails.application.config.assets.precompile += %w( bootstrap/plugins/circles-master.js )
